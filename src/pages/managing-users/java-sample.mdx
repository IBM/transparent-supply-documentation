...
automating your data uploads to **<SolutionName />**.
...
payload is then transmitted to <SolutionName /> and the result is returned.
...
submission to <SolutionName />. This code will be maintained for any future authentication
...
- The <SolutionName /> environment ("SANDBOX" or "PRODUCTION")
...
```
  ...
  iftCloudIAMURL=https://iam.ng.bluemix.net/oidc/token
