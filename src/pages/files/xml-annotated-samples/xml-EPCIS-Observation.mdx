---
title: EPCIS Observation Event XML example
description: Example of EPCIS Observation Event XML data for upload
---

<PageDescription>

EPCIS Observation Event data is uploaded in XML format, as shown in the
example below.

</PageDescription>

## EPCIS Observation Event XML example

The following example shows example EPCIS Observation Event data in XML:
  ...
  <EPCISBody>
    <EventList>
      <ObjectEvent>
        ...
        <!--OPTIONAL: SGLN FTLI, or SFTLI for point at which item was scanned. Used if multiple facilities GLNs (look below for the Mandatory GLN).-->
