---
title: EPCIS Commission Event XML example
description: Example of EPCIS Commission Event XML data for upload
---

<PageDescription>

EPCIS Commission Event data is uploaded in XML format, as shown in the
example below.

</PageDescription>

## EPCIS Commission Event XML example

The following example shows example EPCIS Commission Event data in XML:
  ...
  <EPCISBody>
    <EventList>
      <ObjectEvent>
        ...
        <!--List of commissioned instance-level objects (SSCC, SGTIN).-->
        ...
        <!--The business step should be "creating_class_instance" for comissioning lots,-->
        <!--and "commissioning" for commissioning serials-->
        ...
        <!--OPTIONAL: SGLN, FTLI, or SFTLI for point at which the commissioning occurred. Used if multiple facilities GLNs (look below for the Mandatory GLN).-->
        ...
        <extension>
          ...
          <ilmd>
            ...
            <cbvmda:farmList>
              <cbvmda:farm>
                <cbvmda:farmIdentification>urn:epc:id:sgln:0614141.00001.0</cbvmda:farmIdentification>
