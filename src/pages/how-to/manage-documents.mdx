...
The **<SolutionName />** **Documents** module enables your **organization** to upload,
...
To launch the module, expand the <SolutionName /> main menu and select **Documents**.
...
from <SolutionName />. Any organizations that you have shared the document with will no longer be
able to view it. Records of all actions taken for this document will remain on <SolutionName />.
