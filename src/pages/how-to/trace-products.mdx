...
The **<SolutionName />** **Trace** module enables authorized users to view and take
...
the same product instance. This sharing of data enables <SolutionName /> business
...
End-to-end product traceability on <SolutionName /> means that authorized users can easily
...
* <SolutionName /> Trace examples include identifying a product instance that originated from
...
The following procedure describes how to trace products in <SolutionName />:

1. Once you are logged into <SolutionName />, select the Trace module from the main menu.
