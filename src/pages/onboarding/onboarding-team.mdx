...
integration specialists. The **<SolutionName />** **Onboarding team member**
...
IBMid</a> for authenticating to <SolutionName />. Then add their name, and the email address used
to register their IBMid, to the **Onboarding team member** role in the Onboarding module.

## Onboarding data

Data that each **Onboarding team member** user will upload include GS1, or <SolutionName />
