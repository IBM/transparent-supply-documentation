...
the supply chain for any specific product instance. However, any other
...
Business transaction data, including Purchase Orders (PO), Despatch Advice (DA/ASN)
and Receive Advice (RA) documents, are shared and visible **ONLY** to the transaction
...
**Data shared only with the transaction partner:**
Product events, product and location data, and transaction documents, including
Purchase Orders (PO), Despatch Advice (DA/ASN), and Receive Advice (RA), are visible
