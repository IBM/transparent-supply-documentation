...
To facilitate data integration between **<SolutionName />** and the local
...
are commonly used in <SolutionName />. A complete list of <a href="https://www.gs1.org"
...
As shown in Table 1 below, <SolutionName /> uses GS1 URNs, which follow the <a
...
<p>
  <SolutionName /> surfaces read point data through the Trace API only, it is not available through the UI. For an example of <SolutionName /> read point upload syntax, see the annotated <a href="../files/xml-annotated-samples/xml-EPCIS-Commission">Commission Event XML</a>. For GS1 read point details, refer to section 7.3.4 of the <a href="https://www.gs1.org/sites/default/files/docs/epc/EPCIS-Standard-1.2-r-2016-09-29.pdf" target="_blank">GS1 EPCIS Standard</a>.
</p>
