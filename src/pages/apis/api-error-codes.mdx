...
When posting data through an <SolutionName /> API call, you may receive an error
indicating a supplied ID value does not match the expected <SolutionName /> or
...
An <SolutionName /> API may return a pattern match error message:
