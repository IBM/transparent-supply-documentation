...
The **IBM Blockchain Transparent Supply™** <a href={process.env.GATSBY_UI_URL + '/ift/api/outbound/api-docs/'}
...
3. For IBM Blockchain Transparent Supply™ organizations to share and trace supply chain data, each
...
You must first provide a valid IBM Blockchain Transparent Supply™ authorization token (human user token) on
...
| IBM Blockchain Transparent Supply™ product ID with Lot # | urn:ibm:ift:product:lot:class:1234567890123.product-123.lot4 <br /> urn:ibm:ift:product:lot:class:`<Company Prefix>.<Item Reference>.<Lot Number>` |
| IBM Blockchain Transparent Supply™ product ID with Serial # | urn:ibm:ift:product:serial:obj:1234567890123.product-123.serial-number-4567 <br /> urn:ibm:ift:product:serial:obj:`<Company Prefix>.<Item Reference>.<Serial Number>` |
